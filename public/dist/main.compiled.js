        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                URL_DELETE_POST = "/insider-hub/post-options?post_id=".concat(dataPostId);
                _context.next = 4;
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              URL_PIN_POST = "/insider-hub/post-options/update?post_id=".concat(dataPostId);
              _context2.next = 4;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return fetch("/insider-hub/post-options?post_id=".concat(dataPostId_delete), {
                  method: "DELETE",
                  cache: "no-cache",
                  mode: "cors"
                });
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.prev = 0;
                _context2.next = 3;
                return fetch("/insider-hub/post-options?post_id=".concat(dataPostId_update), {
                  method: "PUT",
                  headers: {
                    "Content-Type": "application/json"
                  },
