...
window.addEventListener("DOMContentLoaded", function () {
  ...
  var deleteDialogConfirm = document.querySelectorAll(".custom__dialog-btn-confirm"); // Option Card open
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return fetch("/evsu-insider/post-options?post_id=".concat(dataPostId), {
                  method: "DELETE",
                  cache: "no-cache",
                  mode: "cors"
                });
